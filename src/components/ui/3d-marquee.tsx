...
export const ThreeDMarquee = ({ items, className }: { items: ItemType[]; className?: string }) => {
  ...
  return (
    <div className={cn('mx-auto block h-[600px] overflow-hidden rounded-2xl max-sm:h-[500px] relative', className)}>
      <div className="absolute top-0 left-0 w-full h-20 bg-linear-to-b from-black to-transparent z-20 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-full h-20 bg-linear-to-t from-black to-transparent z-20 pointer-events-none" />
