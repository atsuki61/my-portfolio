...
import { cn } from '@/utils/cn'; // ← ここを修正しました
...
export const CometCard = ({
  ...
  return (
    <div className={cn('group perspective-distant transform-3d', className)}>
      <motion.div
        ref={ref}
        ...
        style={{
          ...
          translateX,
          translateY,
          transformStyle: 'preserve-3d', // 3D効果を維持するために追加
          boxShadow:
        ...
        className="relative rounded-2xl will-change-transform" // パフォーマンス向上のため追加
      >
        {children}
        <motion.div
